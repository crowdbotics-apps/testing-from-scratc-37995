...
## Project Structure
    ...
    ├── testing_from_scratc_37995  # Django project configurations
...
1. Clone this repo and `cd testing_from_scratc_37995`
...
2. Clone this repo and `cd testing_from_scratc_37995`
